...
const homeController = {
  ...
  redireccionarI: async (req, res) => {
    ...
    const recordarUsuario = req.body.recordar__usuario;
    console.log("esto es", recordarUsuario, "esto es recordar usuario");
    if (!errors.isEmpty()) {
    ...
    try {
      ...
      if (userLogin) {
        ...
        if (isApassword) {
          ...
          console.log(recordarUsuario, "esto es recordar usuario");
          // Configura la cookie solo si recordarUsuario es verdadero
